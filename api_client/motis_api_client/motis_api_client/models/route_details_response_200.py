...
T = TypeVar("T", bound="RouteDetailsResponse200")


@_attrs_define
class RouteDetailsResponse200:
    """
    Attributes:
        routes (list[RouteInfo]):
        polylines (list[RoutePolyline]):
        stops (list[Place]):
        zoom_filtered (bool): Always false for this endpoint.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        route_details_response_200 = cls(
            routes=routes,
            polylines=polylines,
            stops=stops,
        ...
        route_details_response_200.additional_properties = d
        return route_details_response_200
