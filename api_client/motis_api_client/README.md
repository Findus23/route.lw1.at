# motis-api-client
A client library for accessing MOTIS API
...
```python
from motis_api_client import AuthenticatedClient
...
```python
from motis_api_client.models import MyDataModel
from motis_api_client.api.my_tag import get_my_data_model
from motis_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `motis_api_client.api.default`
